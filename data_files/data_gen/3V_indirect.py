# 3V systems, indirect causal interaction between X and Y
...
# save_dir
save_dir=os.path.join(root, 'data_files', 'data', 'gen', '3V_indirect')
...
if args.noiseType!=None and args.noiseType.lower()!='none':
    data.to_csv(os.path.join(save_dir, f'3V_indirect_{args.noiseType}_{args.noiseInjectType}_{args.noiseLevel}.csv'), index=False)
else:
    data.to_csv(os.path.join(save_dir, '3V_indirect_noNoise.csv'), index=False)
