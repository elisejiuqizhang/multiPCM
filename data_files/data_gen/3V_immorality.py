...
# save_dir
save_dir=os.path.join(root, 'data_files', 'data', 'gen', '3V_immorality')
...
if args.noiseType!=None and args.noiseType.lower()!='none':
    data.to_csv(os.path.join(save_dir, f'3V_immorality_{args.noiseType}_{args.noiseInjectType}_{args.noiseLevel}.csv'), index=False)
else:
    data.to_csv(os.path.join(save_dir, '3V_immorality_noNoise.csv'), index=False)